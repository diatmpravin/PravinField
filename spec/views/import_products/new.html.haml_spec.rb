...
describe "import_products/new" do
  before(:each) do
    assign(:import_product, stub_model(ImportProduct,
      :name => "MyString",
      :description => "MyText",
  ...
  it "renders new import_product form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => import_products_path, :method => "post" do
